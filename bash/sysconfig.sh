...
echo "Displaying system: for --help status for host --host ."
echo ""
echo "--ipconfig --domain --os --cpu --memory --disk --printer"
...
function cleanup {
rm -f $tempfile
rm /tmp/sysinfo.$$ /tmp/businfo.$$ /tmp/cpuinfo.$$ /tmp/memoryinfo.$$
echo "Files cleaned."
